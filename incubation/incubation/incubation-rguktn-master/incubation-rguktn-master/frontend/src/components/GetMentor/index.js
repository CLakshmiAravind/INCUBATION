        ...
        <FormWrap>
          ...
          <FormContent>
            ...
            <Form action="#" onSubmit={handleSubmit}>
              ...
              <FormLabel htmlFor="for">Rgukt mail</FormLabel>
              <FormInput
                type="email"
                name="email"
                //required
              ...
              <FormInput
                ...
                onChange={handleChange}
              />
               <FormLabel htmlFor="for">Qualification</FormLabel>
              <Select name="selectList" id="selectList">
   <option value="MTECH">M.Tech</option>
   <option value="PH.D">Ph.D</option>
   <option value="m.Tech">m.Tech, (ph.d)</option>
...
<br></br>
<FormLabel htmlFor="for">Area Of Interest</FormLabel>
              <FormInput
                type="text"
                required
