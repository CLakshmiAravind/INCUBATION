              ...
              return (
                <>
                  ...
                  <Wrap>
                    ...
                    <BtnWrap>
                    <AccBtnV onClick={() => toggle(index)} key={post._id}>
                       View
                      </AccBtnV>
                      <AccBtn>
                  ...
                  {clicked === index ? (
                    <Dropdown>
                      <AccP1>Category {post.category}</AccP1>
                      <AccP1>costEstimated: {post.costEstimated}</AccP1>
                      <AccP1>outline: {post.outline}</AccP1>
                      <AccP3>abstract: {post.abstract}</AccP3>
                      <Footer>
                        Created on{" "}
